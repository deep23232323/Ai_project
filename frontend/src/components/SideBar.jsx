        ...
        >
          {conversations.map((conv, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex items-center justify-center shrink-0 w-[20px] h-[20px] rounded-lg transition-colors
                  duration-150
                  ${
                    isActive
          ...
          border-indigo-500/25"
                  ...
                  <div
                    className="w-9 h-9 rounded-[10px] bg-white/[0.06] flex
        ...
        >
          {conversations.map((conv, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex items-center justify-center shrink-0 w-[28px] h-[28px] rounded-lg transition-colors
                  duration-150
                  ${
                    isActive
                      ? "bg-indigo-500/15 text-indigo-400"
