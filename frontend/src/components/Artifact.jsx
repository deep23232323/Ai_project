  ...
  const PanelContent = ({onClose}) => {
    return (
      <>
        {!collapsed ? (
          ...
          bg-transparent border-none cursor-pointer shrink-0"
              ...
              hover:bg-white/5 rounded-lg transition-colours duration-150 bg-transparent border-none cursor-pointer"
                >
      ...
      bg-transparent border-none cursor-pointer shrink-0"
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              <div
                className="text-[10px] font-medium text-slate-600 tracking-widset uppercase whitespace-nowrap"
                style={{
  ...
  return (
    <>
        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden fixed inset-y-0 right-0 z-50 w-[88vw] max-w-105 border-l border-white/6 overflow-hidden"
            >
      ...
      <motion.div
        ...
        className="hidden lg:flex h-full border border-white/6 flex-col
    overflow-hidden shrink-0 w-62.5"
      >
        <PanelContent />
      </motion.div>
    </>
