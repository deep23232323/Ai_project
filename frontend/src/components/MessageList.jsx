        ...
        {messages.length==0 || !selectedConversation ? (
            ...
            text-center'>
                ...
                <div className='flex flex-wrap justify-center gap-2 mt-1'>
                    {["Build a Netflix Clone","Explain Redis","Build a Dashboard"].map((s, i)=> (
                        <button key={i} className='text-[12px] text-slate-400 bg-white/4 border border-white/[0.07] px-3
                        py-1.5 rounded-lg hover:bg-white/8 hover:text-slate-200 transition-colors duration-150
                        cursor-pointer'>
                            {s}
                        </button>
